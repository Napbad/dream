...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_INT_TOKEN = 15,                 /* INT_TOKEN  */
  ...
  YYSYMBOL_function_declaration = 22,      /* function_declaration  */
  YYSYMBOL_var_decl_list = 23,             /* var_decl_list  */
  YYSYMBOL_qualified_name = 24,            /* qualified_name  */
  YYSYMBOL_expression = 25,                /* expression  */
  YYSYMBOL_expr_list = 26,                 /* expr_list  */
...
{
       0,    59,    59,    67,    70,    77,    80,    83,    86,    89,
      96,   104,   108,   115,   118,   121,   128,   136,   139,   143,
     146,   152,   155,   158,   166,   170
};
#endif
...
{
  "\"end of file\"", "error", "\"invalid token\"", "FUN", "RETURN", "VAR",
  "COMMA", "LBRACE", "RBRACE", "LPAREN", "RPAREN", "COLON", "SEMICOLON",
  "ASSIGN", "IDENTIFIER", "INT_TOKEN", "STRING_LITERAL", "$accept",
  "program", "stmt_list", "stmt", "block", "function_declaration",
  "var_decl_list", "qualified_name", "expression", "expr_list", "var_decl", YY_NULLPTR
};
...
{
     -16,    11,     9,   -16,     5,    21,   -16,   -16,   -16,   -16,
     -16,    -6,    15,    17,    33,   -16,    34,    32,    25,    35,
     -16,   -16,     5,   -16,   -16,     0,    25,    24,    31,   -16,
      25,   -16,   -16,     5,    14,   -16,   -16,   -16,   -16,    39,
       1,   -16,   -16
};
...
{
       3,     0,     2,     1,     0,     0,    16,    17,    18,     4,
       9,    19,     0,     0,     0,     8,    19,     0,    21,    25,
       5,     6,    13,     7,    22,     0,     0,     0,     0,    14,
       0,    20,    24,     0,     0,    23,    15,     3,    11,     0,
       0,    12,    10
};
...
{
      11,    17,    14,    18,     4,     5,    30,    29,    19,    42,
      31,     3,     4,     5,    24,     6,     7,     8,    36,     6,
      28,    37,    32,     6,     7,     8,    35,    20,     6,    21,
      33,    28,    39,    15,    34,     6,     7,     8,    11,     6,
       7,     8,    22,    18,    23,    19,    37,    40,    26,     0,
       0,    41
};

static const yytype_int8 yycheck[] =
{
       2,     5,     4,     9,     3,     4,     6,    22,    14,     8,
      10,     0,     3,     4,    18,    14,    15,    16,    33,    14,
      22,     7,    26,    14,    15,    16,    30,    12,    14,    12,
       6,    33,    34,    12,    10,    14,    15,    16,    40,    14,
      15,    16,     9,     9,    12,    14,     7,    37,    13,    -1,
      -1,    39
};
...
{
       0,    18,    19,     0,     3,     4,    14,    15,    16,    20,
      22,    24,    25,    27,    24,    12,    24,    25,     9,    14,
      12,    12,     9,    12,    25,    26,    13,    23,    24,    27,
       6,    10,    25,     6,    10,    25,    27,     7,    21,    24,
      19,    21,     8
};
...
#line 59 "./parser.y"
              {
        program = new ast_::Program(new ast_::BlockStmt(*(yyvsp[0].stmtvec)));
    }
...
#line 67 "./parser.y"
                {
        (yyval.stmtvec) = new std::vector<ast_::Stmt*>();
    }
...
#line 77 "./parser.y"
                         {
        (yyval.stmt) = new ast_::ExprStmt((yyvsp[-1].expr));
    }
...
#line 83 "./parser.y"
                                  {
        (yyval.stmt) = new ast_::ReturnStmt((yyvsp[-1].expr));
    }
...
#line 86 "./parser.y"
                       {
        (yyval.stmt) = new ast_::ReturnStmt(nullptr);
    }
...
#line 96 "./parser.y"
                            {
        (yyval.block) = new ast_::BlockStmt(*(yyvsp[-1].stmtvec));
...
#line 1203 "./parser.cpp"
  ...
  case 12: /* function_declaration: FUN qualified_name LPAREN var_decl_list RPAREN qualified_name block  */
#line 108 "./parser.y"
                                                                           {
        (yyval.stmt) = new ast_::FuncDecl((yyvsp[-1].ident), (yyvsp[-5].ident), *(yyvsp[-3].varvec), (yyvsp[0].block));
        delete (yyvsp[-3].varvec);
    }
#line 1212 "./parser.cpp"
    break;

  case 13: /* var_decl_list: %empty  */
#line 115 "./parser.y"
                     {
    	(yyval.varvec) = new std::vector<ast_::VarDecl*>();
    }
#line 1220 "./parser.cpp"
    break;

  case 14: /* var_decl_list: var_decl  */
#line 118 "./parser.y"
               {
        (yyval.varvec) = new std::vector<ast_::VarDecl*>{(yyvsp[0].var_decl)};
    }
#line 1228 "./parser.cpp"
    break;

  case 15: /* var_decl_list: var_decl_list COMMA var_decl  */
#line 121 "./parser.y"
                                   {
...
#line 139 "./parser.y"
                     {
        (yyval.expr) = new ast_::StringExpr((yyvsp[0].string)->substr(1, (yyvsp[0].string)->length() - 2));
        delete (yyvsp[0].string); // Clean up the string
    }
#line 1263 "./parser.cpp"
    break;

  case 19: /* expression: qualified_name  */
#line 143 "./parser.y"
                     {
        (yyval.expr) = new ast_::VarExpr((yyvsp[0].ident));
    }
#line 1271 "./parser.cpp"
    break;

  case 20: /* expression: qualified_name LPAREN expr_list RPAREN  */
#line 146 "./parser.y"
                                             {
        (yyval.expr) = new ast_::CallExpr((yyvsp[-3].ident), *(yyvsp[-1].exprvec));
    }
...
#line 152 "./parser.y"
                {
	(yyval.exprvec) = new std::vector<ast_::Expr*>();
    }
#line 1287 "./parser.cpp"
    break;

  case 22: /* expr_list: expression  */
#line 155 "./parser.y"
                {
        (yyval.exprvec) = new std::vector<ast_::Expr*>{(yyvsp[0].expr)};
    }
#line 1295 "./parser.cpp"
    break;

  case 23: /* expr_list: expr_list COMMA expression  */
#line 158 "./parser.y"
                                {
