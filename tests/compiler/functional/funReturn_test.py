...
def testFunReturn(dap_main, source_runtime_dir, debug_mode = False):
    arg = ""
    script_path = Path(__file__).resolve()
    script_dir = script_path.parent
    dap_file = script_dir / "funReturn_test.dap"
    ...
    print(Fore.BLUE + "Testing: ./functional/funReturn_test.dap")
    ...
    test_report_compare(target_run_result, dap_file, "function return", "b")
