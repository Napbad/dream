...
def testTruncExpression(dap_main, source_runtime_dir, debug_mode = False):
    arg = ""

    script_path = Path(__file__).resolve()
    script_dir = script_path.parent
    dap_file = script_dir / "truncExpression_test.dap"
    ...
    test_report_default(result, dap_file, "trunc expression syntax")
