...
def testFullName(dap_main, source_runtime_dir, debug_mode = False):
    arg = ""

    script_path = Path(__file__).resolve()
    script_dir = script_path.parent
    dap_file = script_dir / "fullName_test.dap"
    ...
    test_report_default(result, dap_file, "full name syntax")
