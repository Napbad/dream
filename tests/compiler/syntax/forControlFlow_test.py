...
def testForControlFlow(dap_main, source_runtime_dir, debug_mode = False):
    arg = ""

    script_path = Path(__file__).resolve()
    script_dir = script_path.parent
    dap_file = script_dir / "forControl_test.dap"
    ...
    test_report_default(result, dap_file, "for control syntax")