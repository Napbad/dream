...
namespace antlr4 {
  ...
  public:
    ...
    ///        What parse got the error. From this
    ...
    /// <param name="e">
    ///        The exception generated by the parse that led to
    ///        the reporting of an error. It is null in the case where
    ///        the parse was able to recover in line without exiting the
    ///        surrounding rule. </param>
    virtual void syntaxError(Recognizer *recognizer, Token *offendingSymbol, size_t line,
                             size_t charPositionInLine, const std::string &msg, std::exception_ptr e) = 0;

    /**
     * This method is called by the parse when a full-context prediction
     ...
     * mode is used, the parse is required to identify exact ambiguities so
    ...
    /**
     * This method is called when an SLL conflict occurs and the parse is about
    ...
    /**
     * This method is called by the parse when a full-context prediction has a
     * unique result.
     *
     * <p>Each full-context prediction which does not result in a syntax error
     * will call either {@link #reportContextSensitivity} or
